...
<!-- Main Content-->
    ...
    <main class="main-content">
      ...
      <div class="home-content">
        <div class="container">
         ...
         <a href="https://play.google.com/store/apps/details?id=com.freedentist" target='_blank'>  <img src="{{url('public/img/and.png')}}" width="300" alt="Free Dentist"></a>
          </div>
          <div class="bannerRow">
            ...
            <div class="row">
                  ...
                  <option class="locate" selected disabled data-image="{{asset('public/assets/imgs/home/doctor.svg')}}">@lang('home.service')</option>
    ...
    text-overflow: ''; " required name="city" id="city_id">
                  <option class="locate" selected disabled data-image="{{ asset('public/assets/imgs/home/location.svg') }}">@lang('home.city')  </option>
    ...
    text-overflow: ''; " class="form-control" name="hospital_id" id="hospital_id" required>
                  <option class="locate"  selected disabled  data-image="{{asset('public/assets/imgs/home/location.svg')}}"><span style="color:#C7C7C7;">@lang('home.center') </span></option>
              ...
              -->
               ...
               <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                 <div class="input-group-append" data-target="#datetimepicker1" data-toggle="datepicker">
                   <div class="input-group-text"><img src="{{ asset('public/assets/imgs/home/calender.svg') }}"></div>
                 </div>
                 <input class="form-control datepicker-input" type="text" data-target="#datetimepicker1" name="date" placeholder=" @lang('home.time')">
                
               </div>
              </div>
			   <input class="form-control datepicker-input" value='2019-8-21,2019-8-24' type="hidden" id="date_id">
          ...
          <div class="stepsRow">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="step step1"><img src="{{asset('public/assets/imgs/home/location2.svg')}}">
              ...
              <div class="col-md-3">
                <div class="step step2">
                  <div class="stepSquare"></div><img src="{{ asset('public/assets/imgs/home/hospital.png') }}">
                  <h4>@lang('home.feature2')</h4>
                </div>
              </div>
              <div class="col-md-3">
                <div class="step step1"><img src="{{ asset('public/assets/imgs/home/calender2.svg') }}">
                  <div class="stepSquare"></div>
              ...
              <div class="col-md-3">
                <div class="step step2">
                  <div class="stepSquare"></div><img src="{{ asset('public/assets/imgs/home/teeth.svg') }}">
